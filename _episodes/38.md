...
episode_number: 38
guest: David Beaver
title: (38) Phil Phails @ Neutrality with David Beaver
description: Phillip Jones and linguist David Beaver unpack why claiming neutrality often masks power, using examples from politics, academia, and history. Real talk on framing, decisions, and showing up honestly in divided times.
header:
    video:
        id: nkxFpBjO8mc
        provider: youtube
    teaser: /episodes/assets/images/returningDavidBeaver.jpg
