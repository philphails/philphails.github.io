...
1. **Subjective Experience** – My personal story, centered on my time with the bike group ride community, illustrating how ADHD traits and group dynamics played out in real time.  
2. **Objective Deep Dive** – An exploration of psychological and neuroscientific research related to the dynamics of that stage, with a focus on ADHD-specific angles.  
3. **Reflection Questions & Exercises** – Practical tools for self-exploration and skill-building, so readers can connect the science to their own journey.  
4. **Further Reading** – Curated, annotated recommendations to extend the learning and offer perspectives from psychology, sociology, and lived experience.
...
1. **Mapping the Micro-Moments (Awareness & Context)**  
...
3. **Recognizing Masking & Social Exhaustion**  
...
4. **Exploring Double Standards & Fairness Sensitivity**  
...
5. **Practicing Nonviolent Curiosity**  
...
* Translate it into a clear, actionable request:  
   *“Behave yourself while wearing the jersey.” → “We’d like members to avoid swearing during shop-sponsored events.”*  
* Notice how this shift feels. Does it create a path forward, or does it still feel like a demand to erase yourself?
...
* **How does this grief show up in your body?** (Tightness in chest, racing thoughts, fatigue?)  
   **Exercise:** Write a short journal entry beginning with:  
  * “What I lost was…”  
...
* **What alternative story might also be true?**  
   **Exercise:** Write your current story about the exclusion, then rewrite it as if narrated by a wise, kind observer who sees your goodness. Compare how the two versions feel in your body.
...
* **Where in your life are those needs currently being met — even in small ways?**  
   **Exercise:** Draw two columns labeled “Unmet Needs” and “Places I Am Still Fed.” For every need you list in the first column, see if you can name one person, space, or practice that partially meets it in the second.

  ### **4\. Interrupting Rumination Loops**
...
* **Which emotion is strongest in that replay — shame, anger, sadness, confusion?**  
   **Exercise:** Set a timer for 10 minutes and write a “thought dump” of everything swirling in your head about the incident. When the timer ends, fold the paper and place it somewhere safe — signaling to your brain that it’s been heard and can rest for now.

  ### **5\. Reclaiming Dignity**
...
1. **Clear, Private, Actionable Feedback**  
...
4. **Restorative Scenario Planning**  
...
1. **ADHD, Emotional Regulation, and the Brain**
...
2. **Social Pain is Physical Pain**
...
3. **Reframing and Self-Compassion**
...
1. The “default” story (how your RSD framed it).  
2. The “kind observer” story (as if narrated by someone who loves and trusts you).  
